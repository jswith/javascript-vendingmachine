...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".login-button {\n  align-self: flex-end;\n  cursor: pointer;\n}\n\n.user-info-button {\n  align-self: flex-end;\n  height: 36px;\n  width: 36px;\n  border-radius: 50%;\n  color: var(--user-info-thumbnail-font-color);\n  border: 1px solid var(--user-info-button-border-color);\n  background-color: var(--user-info-thumbnail-bg-color);\n  cursor: pointer;\n}\n\n.signup-form,\n.signin-form,\n.edit-profile-form {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-direction: column;\n}\n\n.signup-form label,\n.signin-form label,\n.edit-profile-form label {\n  align-self: flex-start;\n}\n\n.signup-form input,\n.signin-form input,\n.edit-profile-form input {\n  width: 280px;\n  margin-bottom: 20px;\n}\n\n.edit-profile-form input:disabled {\n  background-color: var(--input-disabled-bg-color);\n}\n\n.signup-form button,\n.signin-form button,\n.edit-profile-form button {\n  width: 280px;\n  height: 35px;\n  margin-top: 10px;\n  background-color: var(--submit-button-bg-color);\n  border: 0;\n  border-radius: 4px;\n  color: #fff;\n  cursor: pointer;\n}\n\n.signup-text {\n  cursor: pointer;\n  color: var(--signup-text-color);\n}\n\n.select-box-wrapper {\n  align-self: flex-end;\n  display: flex;\n  position: relative;\n  flex-direction: column;\n}\n\n.select-box {\n  position: absolute;\n  top: 40px;\n  right: 0px;\n  align-items: center;\n}\n\n.select-box-flex {\n  display: flex;\n  flex-direction: column;\n}\n\n.select-box button {\n  background: var(--button-bg-color);\n  width: 100px;\n  cursor: pointer;\n}\n\n.select-box .select-box__edit-profile-button,\n.select-box .select-box__logout-button {\n  padding: 5px;\n  border: none;\n}\n\n.select-box .select-box__edit-profile-button {\n  border-bottom: 1px solid var(--select-box-border-color);\n  border-radius: 10px 10px 0 0;\n}\n\n.select-box .select-box__logout-button {\n  border-radius: 0 0 10px 10px;\n}\n\n.select-box .select-box__edit-profile-button:hover,\n.select-box .select-box__logout-button:hover {\n  background-color: var(--select-box-button-color);\n}\n", "",{"version":3,"sources":["webpack://./src/css/auth.css"],"names":[],"mappings":"AAAA;EACE,oBAAoB;EACpB,eAAe;AACjB;;AAEA;EACE,oBAAoB;EACpB,YAAY;EACZ,WAAW;EACX,kBAAkB;EAClB,4CAA4C;EAC5C,sDAAsD;EACtD,qDAAqD;EACrD,eAAe;AACjB;;AAEA;;;EAGE,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,sBAAsB;AACxB;;AAEA;;;EAGE,sBAAsB;AACxB;;AAEA;;;EAGE,YAAY;EACZ,mBAAmB;AACrB;;AAEA;EACE,gDAAgD;AAClD;;AAEA;;;EAGE,YAAY;EACZ,YAAY;EACZ,gBAAgB;EAChB,+CAA+C;EAC/C,SAAS;EACT,kBAAkB;EAClB,WAAW;EACX,eAAe;AACjB;;AAEA;EACE,eAAe;EACf,+BAA+B;AACjC;;AAEA;EACE,oBAAoB;EACpB,aAAa;EACb,kBAAkB;EAClB,sBAAsB;AACxB;;AAEA;EACE,kBAAkB;EAClB,SAAS;EACT,UAAU;EACV,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,sBAAsB;AACxB;;AAEA;EACE,kCAAkC;EAClC,YAAY;EACZ,eAAe;AACjB;;AAEA;;EAEE,YAAY;EACZ,YAAY;AACd;;AAEA;EACE,uDAAuD;EACvD,4BAA4B;AAC9B;;AAEA;EACE,4BAA4B;AAC9B;;AAEA;;EAEE,gDAAgD;AAClD","sourcesContent":[".login-button {\n  align-self: flex-end;\n  cursor: pointer;\n}\n\n.user-info-button {\n  align-self: flex-end;\n  height: 36px;\n  width: 36px;\n  border-radius: 50%;\n  color: var(--user-info-thumbnail-font-color);\n  border: 1px solid var(--user-info-button-border-color);\n  background-color: var(--user-info-thumbnail-bg-color);\n  cursor: pointer;\n}\n\n.signup-form,\n.signin-form,\n.edit-profile-form {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-direction: column;\n}\n\n.signup-form label,\n.signin-form label,\n.edit-profile-form label {\n  align-self: flex-start;\n}\n\n.signup-form input,\n.signin-form input,\n.edit-profile-form input {\n  width: 280px;\n  margin-bottom: 20px;\n}\n\n.edit-profile-form input:disabled {\n  background-color: var(--input-disabled-bg-color);\n}\n\n.signup-form button,\n.signin-form button,\n.edit-profile-form button {\n  width: 280px;\n  height: 35px;\n  margin-top: 10px;\n  background-color: var(--submit-button-bg-color);\n  border: 0;\n  border-radius: 4px;\n  color: #fff;\n  cursor: pointer;\n}\n\n.signup-text {\n  cursor: pointer;\n  color: var(--signup-text-color);\n}\n\n.select-box-wrapper {\n  align-self: flex-end;\n  display: flex;\n  position: relative;\n  flex-direction: column;\n}\n\n.select-box {\n  position: absolute;\n  top: 40px;\n  right: 0px;\n  align-items: center;\n}\n\n.select-box-flex {\n  display: flex;\n  flex-direction: column;\n}\n\n.select-box button {\n  background: var(--button-bg-color);\n  width: 100px;\n  cursor: pointer;\n}\n\n.select-box .select-box__edit-profile-button,\n.select-box .select-box__logout-button {\n  padding: 5px;\n  border: none;\n}\n\n.select-box .select-box__edit-profile-button {\n  border-bottom: 1px solid var(--select-box-border-color);\n  border-radius: 10px 10px 0 0;\n}\n\n.select-box .select-box__logout-button {\n  border-radius: 0 0 10px 10px;\n}\n\n.select-box .select-box__edit-profile-button:hover,\n.select-box .select-box__logout-button:hover {\n  background-color: var(--select-box-button-color);\n}\n"],"sourceRoot":""}]);
// Exports
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n  --primary-font-color: rgba(0, 0, 0, 0.87);\n  --secondary-font-color: #ffffff;\n  --input-border-color: #b4b4b4;\n  --table-border-color: #dcdcdc;\n  --button-bg-color: #f5f5f5;\n  --button-focus-bg-color: #00bcd429;\n  --submit-button-bg-color: #00bcd4;\n  --select-box-button-color: #98e2ec;\n  --select-box-border-color: #000000;\n  --signup-text-color: #3581d7;\n  --input-disabled-bg-color: #e0e0e0;\n  --user-info-thumbnail-bg-color: #00bcd429;\n  --user-info-thumbnail-font-color: #000000;\n  --user-info-button-border-color: #ffffff;\n}\n\nbody {\n  font-family: 'Roboto';\n  color: var(--primary-font-color);\n  font-style: normal;\n  font-weight: 400;\n  font-size: 16px;\n  line-height: 24px;\n  letter-spacing: 0.5px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\nh1 {\n  margin: 32px 0;\n}\n\n#app {\n  width: 500px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  flex-direction: column;\n}\n\n.nav {\n  margin-bottom: 52px;\n}\n\n.button {\n  background: var(--button-bg-color);\n  border-radius: 4px;\n  border: none;\n  cursor: pointer;\n  width: 100px;\n  height: 36px;\n}\n\n.focus-button {\n  background: var(--button-focus-bg-color);\n}\n\n.submit-button {\n  background: var(--submit-button-bg-color);\n  border-radius: 4px;\n  border: none;\n  color: var(--secondary-font-color);\n  cursor: pointer;\n  width: 56px;\n  height: 36px;\n}\n\ninput {\n  padding: 8px 8px;\n  border: 1px solid var(--input-border-color);\n  box-sizing: border-box;\n  border-radius: 4px;\n}\n\ninput::-webkit-outer-spin-button,\ninput::-webkit-inner-spin-button {\n  -webkit-appearance: none;\n  margin: 0;\n}\n\n.hidden {\n  display: none;\n}\n", "",{"version":3,"sources":["webpack://./src/css/index.css"],"names":[],"mappings":"AAOA;EACE,yCAAyC;EACzC,+BAA+B;EAC/B,6BAA6B;EAC7B,6BAA6B;EAC7B,0BAA0B;EAC1B,kCAAkC;EAClC,iCAAiC;EACjC,kCAAkC;EAClC,kCAAkC;EAClC,4BAA4B;EAC5B,kCAAkC;EAClC,yCAAyC;EACzC,yCAAyC;EACzC,wCAAwC;AAC1C;;AAEA;EACE,qBAAqB;EACrB,gCAAgC;EAChC,kBAAkB;EAClB,gBAAgB;EAChB,eAAe;EACf,iBAAiB;EACjB,qBAAqB;EACrB,aAAa;EACb,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,cAAc;AAChB;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,sBAAsB;AACxB;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,kCAAkC;EAClC,kBAAkB;EAClB,YAAY;EACZ,eAAe;EACf,YAAY;EACZ,YAAY;AACd;;AAEA;EACE,wCAAwC;AAC1C;;AAEA;EACE,yCAAyC;EACzC,kBAAkB;EAClB,YAAY;EACZ,kCAAkC;EAClC,eAAe;EACf,WAAW;EACX,YAAY;AACd;;AAEA;EACE,gBAAgB;EAChB,2CAA2C;EAC3C,sBAAsB;EACtB,kBAAkB;AACpB;;AAEA;;EAEE,wBAAwB;EACxB,SAAS;AACX;;AAEA;EACE,aAAa;AACf","sourcesContent":["@import './table.css';\n@import './product-manage-tab.css';\n@import './charge-tab.css';\n@import './purchase-tab.css';\n@import './auth.css';\n@import './snackbar.css';\n\n:root {\n  --primary-font-color: rgba(0, 0, 0, 0.87);\n  --secondary-font-color: #ffffff;\n  --input-border-color: #b4b4b4;\n  --table-border-color: #dcdcdc;\n  --button-bg-color: #f5f5f5;\n  --button-focus-bg-color: #00bcd429;\n  --submit-button-bg-color: #00bcd4;\n  --select-box-button-color: #98e2ec;\n  --select-box-border-color: #000000;\n  --signup-text-color: #3581d7;\n  --input-disabled-bg-color: #e0e0e0;\n  --user-info-thumbnail-bg-color: #00bcd429;\n  --user-info-thumbnail-font-color: #000000;\n  --user-info-button-border-color: #ffffff;\n}\n\nbody {\n  font-family: 'Roboto';\n  color: var(--primary-font-color);\n  font-style: normal;\n  font-weight: 400;\n  font-size: 16px;\n  line-height: 24px;\n  letter-spacing: 0.5px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\nh1 {\n  margin: 32px 0;\n}\n\n#app {\n  width: 500px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  flex-direction: column;\n}\n\n.nav {\n  margin-bottom: 52px;\n}\n\n.button {\n  background: var(--button-bg-color);\n  border-radius: 4px;\n  border: none;\n  cursor: pointer;\n  width: 100px;\n  height: 36px;\n}\n\n.focus-button {\n  background: var(--button-focus-bg-color);\n}\n\n.submit-button {\n  background: var(--submit-button-bg-color);\n  border-radius: 4px;\n  border: none;\n  color: var(--secondary-font-color);\n  cursor: pointer;\n  width: 56px;\n  height: 36px;\n}\n\ninput {\n  padding: 8px 8px;\n  border: 1px solid var(--input-border-color);\n  box-sizing: border-box;\n  border-radius: 4px;\n}\n\ninput::-webkit-outer-spin-button,\ninput::-webkit-inner-spin-button {\n  -webkit-appearance: none;\n  margin: 0;\n}\n\n.hidden {\n  display: none;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "table caption {\n  font-family: 'Roboto';\n  font-style: normal;\n  font-weight: 600;\n  font-size: 20px;\n  line-height: 24px;\n  text-align: center;\n  letter-spacing: 0.15px;\n  margin-bottom: 14px;\n}\n\ntable {\n  border-collapse: collapse;\n  line-height: 40px;\n}\n\ntd,\nth {\n  width: 118px;\n  text-align: center;\n}\n\ntr {\n  border-top: 1px solid var(--table-border-color);\n  border-bottom: 1px solid var(--table-border-color);\n}\n\n#product-list-table button {\n  width: 50px;\n}\n\n#coin-list-table {\n  margin-top: 38px;\n}\n\n#purchase-product-list-table {\n  margin-top: 30px;\n}\n\n#purchase-coin-list-table {\n  margin-top: 60px;\n  margin-bottom: 20px;\n}\n", "",{"version":3,"sources":["webpack://./src/css/table.css"],"names":[],"mappings":"AAAA;EACE,qBAAqB;EACrB,kBAAkB;EAClB,gBAAgB;EAChB,eAAe;EACf,iBAAiB;EACjB,kBAAkB;EAClB,sBAAsB;EACtB,mBAAmB;AACrB;;AAEA;EACE,yBAAyB;EACzB,iBAAiB;AACnB;;AAEA;;EAEE,YAAY;EACZ,kBAAkB;AACpB;;AAEA;EACE,+CAA+C;EAC/C,kDAAkD;AACpD;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,gBAAgB;EAChB,mBAAmB;AACrB","sourcesContent":["table caption {\n  font-family: 'Roboto';\n  font-style: normal;\n  font-weight: 600;\n  font-size: 20px;\n  line-height: 24px;\n  text-align: center;\n  letter-spacing: 0.15px;\n  margin-bottom: 14px;\n}\n\ntable {\n  border-collapse: collapse;\n  line-height: 40px;\n}\n\ntd,\nth {\n  width: 118px;\n  text-align: center;\n}\n\ntr {\n  border-top: 1px solid var(--table-border-color);\n  border-bottom: 1px solid var(--table-border-color);\n}\n\n#product-list-table button {\n  width: 50px;\n}\n\n#coin-list-table {\n  margin-top: 38px;\n}\n\n#purchase-product-list-table {\n  margin-top: 30px;\n}\n\n#purchase-coin-list-table {\n  margin-top: 60px;\n  margin-bottom: 20px;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
class VendingMachine {
    ...
    addProduct(product) {
        try {
            ...
            this.dispatch(_constants__WEBPACK_IMPORTED_MODULE_0__.ELEMENT_KEY.PURCHASE, 'add', newProduct);
        }
        catch (error) {
    ...
    updateProduct({ targetName, name, price, quantity }) {
        try {
            ...
            this.dispatch(_constants__WEBPACK_IMPORTED_MODULE_0__.ELEMENT_KEY.PURCHASE, 'update', currentProduct);
        }
        catch (error) {
            (0,_utils__WEBPACK_IMPORTED_MODULE_2__.showSnackBar)(error.message);
        }
...
const historyRouterPush = (pathname) => {
    if (pathname === window.location.pathname)
        return;
    if (pathname === '/javascript-vendingmachine/logout')
        pathname = '/javascript-vendingmachine/';
...
const routers = [
    ...
    { path: `${baseURL}/signin`, component: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)('sign-in') },
    { path: `${baseURL}/signup`, component: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)('sign-up') },
    { path: `${baseURL}/editprofile`, component: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)('edit-profile') },
];
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _domain_Auth__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../domain/Auth */ "./src/domain/Auth.ts");
/* harmony import */ var _router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../router */ "./src/router.ts");
/* harmony import */ var _storage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../storage */ "./src/storage.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils */ "./src/utils.ts");
...
class PurchaseTab extends _CustomElement__WEBPACK_IMPORTED_MODULE_0__["default"] {
    ...
    render() {
        this.innerHTML = this.template();
        const userInputMoney = _storage__WEBPACK_IMPORTED_MODULE_4__["default"].getUserMoney();
        const products = _storage__WEBPACK_IMPORTED_MODULE_4__["default"].getProducts();
        (0,_utils__WEBPACK_IMPORTED_MODULE_5__.$)('.purchase-form__money-input-amount', this).textContent = (0,_utils__WEBPACK_IMPORTED_MODULE_5__.markUnit)(userInputMoney);
        products.forEach((product) => this.insertItem(product));
    }
    template() {
    ...
    insertItem(product) {
        (0,_utils__WEBPACK_IMPORTED_MODULE_5__.$)('tbody', this).insertAdjacentHTML('beforeend', `<tr class="product-item" data-product-name="${product.name}" data-product-id="${product.id}">
          <td>${product.name}</td>
    ...
    deleteItem(product) {
        (0,_utils__WEBPACK_IMPORTED_MODULE_5__.$)(`[data-product-id="${product.id}"]`).remove();
    }
...
const validateInputMoney = (money, userInputMoneyAmount) => {
    if (userInputMoneyValidator.isOverMax(money, userInputMoneyAmount)) {
        throw new Error(_constants__WEBPACK_IMPORTED_MODULE_0__.ERROR_MESSAGE.OVER_INPUT_MONEY);
    }
...
/* harmony import */ var _ui_SigninPage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ui/SigninPage */ "./src/ui/SigninPage.ts");
...
/* harmony import */ var _ui_MainUI__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./ui/MainUI */ "./src/ui/MainUI.ts");
...
new _ui_MainUI__WEBPACK_IMPORTED_MODULE_9__["default"]();
